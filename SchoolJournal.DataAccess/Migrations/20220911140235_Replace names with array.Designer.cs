...
namespace SchoolJournal.DataAccess.Migrations
{
    ...
    [Migration("20220911140235_Replace names with array")]
    partial class Replacenameswitharray
    {
            ...
            modelBuilder.Entity("SchoolJournal.DataAccess.Primitives.Lesson", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ab271173-b4d4-4fbc-b76b-416842e7f29e"),
                            ...
                            Marks = "{}",
                            SubjectJournalId = new Guid("27c2daf4-d344-43a0-ab95-096a969134c0")
                        });
                });
            ...
            modelBuilder.Entity("SchoolJournal.DataAccess.Primitives.SubjectJournal", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("27c2daf4-d344-43a0-ab95-096a969134c0"),
                            ClassId = 1,
                            SubjectId = 1,
                            TeacherId = 1
                        });
